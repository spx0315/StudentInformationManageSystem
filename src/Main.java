...
public class Main  {
    ...
    public static void main(String[] args) {
        ...
        ListManagement studentScoreList = new ListManagement();

        System.out.println("**********学生成绩管理系统********");

        while(choice.equals("8") == false) {

            System.out.print("1.查看学生成绩单"+ " \t ");

            System.out.println("2.添加学生成绩记录");

            System.out.print("3.修改学生成绩记录"+ " \t ");

            System.out.println("4.删除学生成绩记录");

            System.out.print("5.查看某位学生成绩记录"+ " \t ");

            System.out.println("6.统计这门课平均分、最高分和最低分");

            System.out.print("7.按成绩从高往低排序，并输出" + " \t ");
